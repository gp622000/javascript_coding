...
// numObj.toLocaleString() will convert the Number to the locale string.
var number = 1200;
console.log(number.toLocaleString()) // "3,500" 
// by default it converts in U.S English Locale.

console.log(number.toLocaleString('de-DE',{style : 'currency',currency:'EUR'}))

num1.toLocaleString('de-De',{style:'currency',currency:'EUR'})
"3.500,00 €"
num1.toLocaleString('de-De',{style:'currency',currency:'JYP'})
"3.500,00 JYP"
